...
class Day5Test {
    ...
    static Stream<Arguments> task1() {
        return Stream.of(Arguments.of(
                "seeds: 79 14 55 13\n" +
                        ...
                        "60 56 37\n" +
                        "56 93 4", 35
        ), Arguments.of("seeds: 91926764 235794528 3279509610 325625103 2781720183 218217413 1315129829 102999617 3995609239 143268116 358337926 185836835 1543999077 241888600 1795811745 806228439 2616560939 56204204 869828854 224520829\n" +
                "\n" +
                "seed-to-soil map:\n" +
    ...
    @ParameterizedTest
    @MethodSource
    void task1(String in, long expected) {
        Day5 test = new Day5(in);
    ...
    static Stream<Arguments> task2() {
        return Stream.of(
                Arguments.of("seeds: 79 14 55 13\n" +
                        "\n" +
                        "seed-to-soil map:\n" +
                        "50 98 2\n" +
                        "52 50 48\n" +
    ...
    @ParameterizedTest
    @MethodSource
    void task2(String in, long expected) {
        Day5 test = new Day5(in);
