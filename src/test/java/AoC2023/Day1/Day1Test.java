...
class Day1Test {
    static Stream<Arguments> task1() {
        return Stream.of(
                ...
                Arguments.of("sixsrvldfour4seven\n" +
    ...
    @ParameterizedTest
    @MethodSource
    public void task1(String input, int correctAnswer) {
        Day1 toTest = new Day1(input);
        int res = toTest.task1();
        assertEquals(res, correctAnswer);
    }

    @MethodSource
    @ParameterizedTest
    public void task2(String input, int correctAnswer) {
        Day1 toTest = new Day1(input);
        int res = toTest.task2();
        assertEquals(res, correctAnswer);
    }
}