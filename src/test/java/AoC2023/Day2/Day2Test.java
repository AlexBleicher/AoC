...
class Day2Test {
    ...
    static Stream<Arguments> task1() {
        return Stream.of(
                ...
                Arguments.of("Game 1: 12 red, 2 green, 5 blue; 9 red, 6 green, 4 blue; 10 red, 2 green, 5 blue; 8 blue, 9 red\n" +
    ...
    @ParameterizedTest
    @MethodSource
    void task1(String input, int expected) {
        Day2 test = new Day2(input);
        int res = test.task1();
    ...
    @MethodSource
    @ParameterizedTest
    void task2(String input, int expected) {
        Day2 test = new Day2(input);
        long res = test.task2();
        assertEquals(res, expected);
    }
