...
public class Input {
    ...
    private String inputTest = "0: 4 1 5\n" +
            "1: 2 3 | 3 2\n" +
            "2: 4 4 | 5 5\n" +
            "3: 4 5 | 5 4\n" +
            "4: \"a\"\n" +
    ...
    private String inputTask2 = "21: 71 69\n" +
            "100: 92 69 | 13 54\n" +
            "116: 34 13 | 41 92\n" +
            "101: 92 93 | 13 96\n" +
            "122: 13 22 | 92 19\n" +
    ...
    private String[] splitInputTask2 = inputTask2.split("\n\n");

    public Map<Integer, String> getAllRules(int number) {
        String rulesInputString = "";
        if (number == 1) {
            rulesInputString = splitInput[0];
        } else {
            rulesInputString = splitInputTask2[0];
        }
    ...
    public List<String> getAllLines(int number) {
        String lineInputString = "";
        if (number == 1) {
            lineInputString = splitInput[1];
        } else {
            lineInputString = splitInputTask2[1];
        }
